...
RUN tar --strip-components=1 -axvf $HFILE && mv tmate /usr/bin && tmate -V
#RUN tar --strip-components=1 -axvf $fileURL
#    HFILE=xvf tmate-2.4.0-static-linux-amd64.tar.xz HASHcmd=sha256sum HASHSUM=6e503a1a3b0f9117bce6ff7cc30cf61bdc79e9b32d074cf96deb0264e067a60d HURL=https://github.com/tmate-io/tmate/releases/download/2.4.0/tmate-2.4.0-static-linux-amd64.tar.xz \
